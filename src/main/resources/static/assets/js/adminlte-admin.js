...
+function ($) {
  ...
  var menuJson=[{
      ...
      "child": [{
          "name": "用户概览",
          "id":"user-generality",
          "controller":"/center/user/generality",
      }]
      //,{
      //    "name": "添加用户",
      //    "id":"user-add",
      //    "controller":"center/user/add.html",
      //}]
  },{
      "name": "文章管理",
      "controller":"#",
      "child": [{
          "name": "文章概览",
          "id":"article-generality",
          "controller":"/center/article/generality",
      },{
          "name": "添加文章",
          "id":"article-add",
          "controller":"/center/article/editor",
      },{
          "name": "审核文章",
          "id":"article-audit",
          "controller":"/audit",
  ...
  function menuInit() {
      ...
      for (var i = 0; i < menuJson.length; i++) {
          ...
          for (var j=0;j<chidLen;j++){
              child = menu.child[j];
              if(i==0&&j==0){
                  html = $('<li class="active" id="'+child.id+'"><a href="javascript:void(0);" menu-controller="'+child.controller+'"><i class="fa fa-circle-o"></i> '+child.name+'</a></li>');
              }else{
                  html = $('<li class="" id="'+child.id+'"><a href="javascript:void(0);" menu-controller="'+child.controller+'"><i class="fa fa-circle-o"></i> '+child.name+'</a></li>');
              }
